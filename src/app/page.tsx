  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50 text-slate-900">
        ...
        <div className="mx-auto grid w-full max-w-5xl gap-8 px-5 py-12 sm:px-8 sm:py-16 lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:gap-14">
          <section aria-labelledby="welcome-heading">
            ...
            <p className="mt-5 max-w-lg text-base leading-7 text-slate-600 sm:text-lg">
              在下一页选择目标等级、题型和练习方式，按照自己的节奏稳步提升日语能力。
            </p>
            <Link
              href="/practice/setup"
              className="mt-8 inline-flex w-full items-center justify-center rounded-xl bg-indigo-600 px-7 py-3.5 font-semibold text-white shadow-sm transition-colors hover:bg-indigo-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 sm:w-auto"
            >
              开始练习
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto max-w-5xl px-5 py-6 text-center text-sm text-slate-500 sm:px-8">
